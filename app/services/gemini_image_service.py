...
GEMINI_IMAGE_STYLE_PRESETS = {
    'realistic': {
        ...
        'prompt_suffix': ', photorealistic, 8k resolution, high quality'
    },
    'illustration': {
        'name': '插画风格',
        'prompt_prefix': 'Beautiful illustration art, detailed artwork, artistic style, ',
        'prompt_suffix': ', digital painting, vibrant colors, high quality'
    },
    'anime': {
        'name': '动漫风格',
        'prompt_prefix': 'Anime style artwork, detailed anime art, Japanese animation style, ',
        'prompt_suffix': ', vibrant colors, clean lines, high quality anime'
    },
    'cyberpunk': {
        'name': '赛博朋克',
        'prompt_prefix': 'Cyberpunk style, neon lights, futuristic cityscape, high-tech atmosphere, ',
        'prompt_suffix': ', dramatic lighting, neon colors, dystopian future, 8k'
    },
    'business': {
        'name': '商业配图',
        'prompt_prefix': 'Professional business illustration, clean design, corporate style, ',
        'prompt_suffix': ', modern aesthetic, professional quality, suitable for presentations'
    },
    'watercolor': {
        'name': '水彩画',
        'prompt_prefix': 'Watercolor painting style, soft colors, artistic brushstrokes, ',
        'prompt_suffix': ', delicate details, flowing colors, artistic quality'
    },
    'minimalist': {
        'name': '极简主义',
        'prompt_prefix': 'Minimalist design, clean composition, simple shapes, ',
        'prompt_suffix': ', modern aesthetics, negative space, elegant simplicity'
    },
    'fantasy': {
        'name': '奇幻风格',
        'prompt_prefix': 'Fantasy art, magical atmosphere, imaginative scene, ',
        'prompt_suffix': ', epic scale, mystical lighting, highly detailed, cinematic'
    }
}
